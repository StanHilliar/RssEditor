<div class="tinyeditor">
	...
	<div class="tinyeditor-divider"></div><div class="tinyeditor-control" title="Left Align" style="background-position: 34px -420px;" ng-click="execCommand('justifyleft')"></div>
	<div class="tinyeditor-control" title="Center Align" style="background-position: 34px -450px;" ng-click="execCommand('justifycenter')"></div>
	<div class="tinyeditor-control" title="Right Align" style="background-position: 34px -480px;" ng-click="execCommand('justifyright')"></div>
	<div class="tinyeditor-control" title="Block Justify" style="background-position: 34px -510px;" ng-click="execCommand('justifyfull')"></div>
	<div class="tinyeditor-divider"></div><div class="tinyeditor-control" title="Remove Formatting" style="background-position: 34px -720px;" ng-click="execCommand('removeformat')"></div>
	<div class="tinyeditor-divider"></div><div class="tinyeditor-control" title="Undo" style="background-position: 34px -540px;" ng-click="execCommand('undo')"></div>
	<div class="tinyeditor-control" title="Redo" style="background-position: 34px -570px;" ng-click="execCommand('redo')"></div></div>
    <div class="tinyeditor-header" ng-hide="editMode">
	...
	<iframe id="iframe" style="-webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box; width: 100%; height: 100%;" ng-hide="editMode" wframe="" ng-model="content"></iframe>
    </div>
